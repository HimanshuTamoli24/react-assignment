                ...
                <ChartContainer config={chartConfig}>
                    <AreaChart accessibilityLayer data={chartData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
                        ...
                        <XAxis
                            ...
                            axisLine={false}
                            tickMargin={8}
                            tickFormatter={(value) => value.slice(0, 10)} // truncate long titles
                        />
...
export function DottedMultiLineChart({ data, title, description, value1Label = "Value 1", value2Label = "Value 2" }: Props) {
    const chartConfig = {
            ...
            <CardContent>
                <ChartContainer config={chartConfig}>
                    ...
                    >
                        ...
                        <XAxis dataKey="label" tickLine={false} axisLine={false} tickMargin={8} tickFormatter={(val) => val.slice(0, 10)} />
